...
export const PRODUCTS: ProductMeta[] = [
  { code: "CB", name: "전환사채", category: "사채형",
    desc: "주식 전환권이 부여된 사채", model: "Tsiveriotis-Fernandes 격자", active: true },
  { code: "EB", name: "교환사채", category: "사채형",
    desc: "발행사가 보유한 타사 주식으로 교환하는 권리가 부여된 사채", model: "교환옵션 격자(타사주)", active: true },
  { code: "BW", name: "신주인수권부사채", category: "사채형",
    desc: "신주인수권(워런트)이 부여된 사채. 분리형/비분리형 구분", model: "워런트 격자(희석·분리형)", active: true },
  { code: "RCPS", name: "상환전환우선주", category: "우선주형",
    desc: "상환권과 전환권을 가진 우선주", model: "측도분리 격자", active: true },
  { code: "CPS", name: "전환우선주", category: "우선주형",
    desc: "전환권을 가진 우선주(상환권 없음)", model: "측도분리 격자", active: true },
